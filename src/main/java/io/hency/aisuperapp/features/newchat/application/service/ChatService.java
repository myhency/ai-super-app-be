package io.hency.aisuperapp.features.newchat.application.service;
...
import io.hency.aisuperapp.features.newchat.application.port.in.ChatUseCase;
...
public class ChatService implements ChatUseCase {
    ...
    private Chat chat(Tuple2<Message, Ulid> tuple, SendChatCommand sendChatCommand) {
        ...
        return Chat.builder()
                .id(sendChatCommand.aiChatId())
                .topicId(sendChatCommand.topicId())
                .parentId(parentId)
                .message(message)
                .createdAt(ZonedDateTime.now())
                .createdBy(sendChatCommand.userId().toString())
                .updatedAt(ZonedDateTime.now())
                .updatedBy(sendChatCommand.userId().toString())
                .build();
    }
}